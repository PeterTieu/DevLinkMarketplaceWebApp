...
const VerifyPhoneNumber = (props) => {
    ...
    //                                     <label htmlFor="otp" className="font-bold text-2xl text-black text-center">
    //                                         Enter your OTP
    //                                     </label>
    ...
    //                                     <label htmlFor="" className="font-bold text-2xl text-black text-center">
    //                                         Verify your phone number
    //                                     </label>

    //                                     <PhoneInput country={"in"} value={ph} onChange={setPh} />

    //                                     <button onClick={onSignup} className="bg-emerald-600 w-full flex gap-1 items-center justify-center py-2.5 text-black rounded">
    //                                         {loading &&
    //                                             <CgSpinner size={20} className="mt-1 animate-spin" />
    //                                         }
